<template>
  <div id="textarea-element" class="main-wr-left">
    <div class="second-hand-sub-apr">
      <div class="collection-name"  :style="{ marginTop: isActive ? 60 + 'px' : '120px' }">APR18</div>
      <img
    ...
    >
      ...
      <div style="margin-top: 50px; width: 100%; ">
        ...
        <div style="width: inherit;"> 
          Models: Laura Butkovič, Nina Butkovič,<br> Valentina Golič, Fejzo Košir
        </div>
      </div>
    </div>
    <SubGalleryDec19
